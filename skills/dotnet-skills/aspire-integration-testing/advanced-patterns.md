...
{
    var url = AspireAppFixture.App.GetEndpointUrl("yourapp");
...
public class DatabaseIntegrationTests
{
    ...
    public async Task Database_ShouldBeInitialized()
    {
        ...
        var dbResource = AspireAppFixture.App.GetResource("yourdb");
        ...
        Assert.That(result > 0, Is.True, "Database should have tables");
    }
}
```
...
public class UIIntegrationTests
{
    ...
    {
        var url = AspirePlaywrightFixture.App.GetEndpointUrl("yourapp");
        var page = await AspirePlaywrightFixture.Browser.NewPageAsync();
...
[SetUpFixture]
public class AspireFixtureWithReset
{
    private static DistributedApplication? _app;
    ...
    // Call from a [SetUp] in each fixture that mutates data
...
{
    var webClient = AspireAppFixture.App.CreateHttpClient("webapp");
    var apiClient = AspireAppFixture.App.CreateHttpClient("api");
    ...
    Assert.That(webResponse.IsSuccessStatusCode, Is.True);
...
{
    var rabbitMqResource = AspireAppFixture.App.GetResource("messaging");
