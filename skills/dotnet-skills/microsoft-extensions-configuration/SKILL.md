...
- [advanced-patterns.md](advanced-patterns.md): Validators with dependencies, named options, complete production example (MessagingSettings), and testing validators
