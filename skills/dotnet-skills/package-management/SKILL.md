...
<Project>
  ...
  <ItemGroup Label="Testing">
    ...
    <PackageVersion Include="Verify.NUnit" Version="26.0.0" />
  </ItemGroup>
</Project>
```

**Benefits:**
- Update all OpenTelemetry packages by changing one variable
...
<PackageVersion Include="OpenTelemetry.Instrumentation.Http" Version="1.10.0" />  <!-- Mismatch! -->
