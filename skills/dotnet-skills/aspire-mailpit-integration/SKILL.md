...
```csharp
// The [SetUpFixture] below runs once for every fixture in the same namespace,
...
public class EmailIntegrationTests
{
    ...
    {
        _client = AspireFixture.CreateClient();
        _mailpit = new MailpitClient(AspireFixture.GetMailpitUrl());
    }
...
public class AspireFixture
{
    ...
    private static string _mailpitUrl = "";
    ...
    public static string GetMailpitUrl() => _mailpitUrl;
